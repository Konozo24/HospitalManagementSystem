...
public class CancelAppointment extends JFrame {
    ...
    public CancelAppointment(HospitalService hospitalService){
        ...
        JLabel titleLabel = new JLabel("Cancel Appointment Form");
            ...
            public void actionPerformed (ActionEvent e){
                if (selectedAppointment != null){
                    ...
                    if (option == JOptionPane.YES_OPTION){
                        ...
                        JOptionPane.showMessageDialog(buttonPanel, "Failed to cancel appointment", "No Selection", JOptionPane.WARNING_MESSAGE);
                    }    
                }
            }
        });
