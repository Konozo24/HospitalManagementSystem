...
public class EditNurseForm extends JFrame {
    ...
    public EditNurseForm(HospitalService hospitalService){
        this.hospitalService = hospitalService;
        this.setTitle("Edit Nurse");
    ...
    private JPanel createFormPanel(){
        ...
        // Open up EditNurseDialog when pressed
        editButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed (ActionEvent e){
                if (selectedNurse != null) {
                    new EditNurseDialog((JFrame) SwingUtilities.getWindowAncestor(formPanel), selectedNurse, hospitalService, () -> {
                        // Refresh table here after save
                        tableModel.setRowCount(0);
                        loadAllNurses(tableModel);
                    }).setVisible(true);
                    selectedNurse = null;
                } else {
                    JOptionPane.showMessageDialog(formPanel, "Please select a nurse to edit.");
                }
            }
        ...
        // Hide the "Object" column, used internally for selecting
        ...
        // Get the Nurse object when the row is selected
