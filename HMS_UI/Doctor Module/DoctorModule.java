...
public class DoctorModule extends JFrame {
    ...
    private JLabel doctorTitleLabel;

    public DoctorModule(HospitalService hospitalService){
    ...
    private void createHeaderPanel() {
        ...
        // Add to header panel
        headerPanel.add(doctorTitleLabel, BorderLayout.CENTER);
    }
    ...
    private void createMenuPanel() {
        ...
        // Create menu buttons
        JButton addDoctorButton = createMenuButton("Add Doctor", "Click to a new doctor to the system");
        addDoctorButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e){
                new AddDoctorForm(hospitalService);
            }
        });
            
       
        JButton removeDoctorButton = createMenuButton("Remove Doctor", "Click to remove doctor");
        removeDoctorButton.addActionListener(new ActionListener(){
            @Override
            public void actionPerformed(ActionEvent e){
                new DeleteDoctorForm(hospitalService);
            }
        });
        

        JButton editDoctorButton = createMenuButton("Edit Doctor", "Click to edit doctor");
        editDoctorButton.addActionListener(new ActionListener(){
            @Override
            public void actionPerformed(ActionEvent e){
                new EditDoctorForm(hospitalService);
            }
        });
        

        JButton viewDoctorButton = createMenuButton("View Doctor", "Click to view doctor");
        viewDoctorButton.addActionListener(new ActionListener(){
            @Override
            public void actionPerformed(ActionEvent e){
                new ViewDoctorForm(hospitalService);
            }
        });
        ...
        row1.add(addDoctorButton);
        row1.add(removeDoctorButton);

        JPanel row2 = new JPanel(new FlowLayout(FlowLayout.CENTER, 20, 10));
        row2.add(editDoctorButton);
        row2.add(viewDoctorButton);
